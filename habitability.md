...
In 2025, I published [a study](https://iopscience.iop.org/article/10.3847/PSJ/adf643) modeling the senstivity of this process to the randomness of plate tectonic collisions, using a model developed by me title *DISKWORLD*.  We found that additional processes resupplying surface rock, such as wind-driven dust transpot, glacial erosion, and seafloor weathering, are likely required in addition to tectonic collisions to keep Earth-like planets habitable over geologic timescales.

<p align="center">
<img src="/assets/img/diskworld.jpg"/>
</p>